 ...
 * {@link com.android.deskclock.provider.AlarmInstance.LOW_NOTIFICATION_HOUR_OFFSET}. This
 ...
 * {@link com.android.deskclock.provider.AlarmInstance.MISSED_TIME_TO_LIVE_HOUR_OFFSET} or until the user acknownledges it.
 *
 * DISMISS_STATE:
...
public final class AlarmStateManager extends BroadcastReceiver {
    ...
    /**
     * Schedule alarm instance state changes with {@link android.app.AlarmManager}.
     *
     * @param context application context
    ...
    /**
     * Cancel all {@link android.app.AlarmManager} timers for instance.
     *
     * @param context application context
     * @param instance to disable all {@link android.app.AlarmManager} timers
     */
