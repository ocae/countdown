...
public class CountingTimerView extends View {
    ...
    static class Hundredths extends UnsignedTime {
         ...
         * {@link com.android.deskclock.timer.CountingTimerView.UnsignedTime#draw(android.graphics.Canvas, String, float, float)}
         */
        @Override
        public float draw(Canvas canvas, final String time, float x, float y) {
    ...
    /**
     * Calculate the square of the diameter to use in {@link com.android.deskclock.timer.CountingTimerView#setTotalTextWidth()}
     */
